                      ...
                      child: Accordion(
                        ...
                        children: [
                          AccordionSection(
                            ...
                            header:
                                Text('¿Qué es PoliPet?', style: _headerStyle),
                            contentBorderColor:
                                Color.fromARGB(255, 90, 185, 81),
                          ...
                          AccordionSection(
                            ...
                            leftIcon: const Icon(Icons.photo_library,
                                color: Colors.white),
                            header: Text('Registro de animales',
                                style: _headerStyle),
                            contentBorderColor:
                                Color.fromARGB(255, 153, 22, 131),
                          ...
                          AccordionSection(
                            isOpen: false,
                            leftIcon: const Icon(Icons.assignment,
                                color: Colors.white),
